/*----- PROTECTED REGION ID(DCS210PC::ClassFactory.cpp) ENABLED START -----*/
/* clang-format on */
//=============================================================================
//
...
class DServerImpl : public Tango::DServer
{
  ...
  private:
      ...
      {
          add_class(DCS210PCClass::init("DCS210PC"));
      }
};
...
/**
 *	Create DCS210PC Class singleton and store it in DServer object.
 */

void Tango::DServer::class_factory()
{
	//	Add method class init if needed
	add_class(DCS210PC_ns::DCS210PCClass::init("DCS210PC"));
}
#endif
/* clang-format off */
/*----- PROTECTED REGION END -----*/	//	DCS210PC::ClassFactory.cpp
