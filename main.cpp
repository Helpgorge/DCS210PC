/*----- PROTECTED REGION ID(DCS210PC::main.cpp) ENABLED START -----*/
/* clang-format on */
//=============================================================================
//
// file :        main.cpp
//
// description : C++ source for the DCS210PC device server main.
...
int main(int argc,char *argv[])
{
	...
	try
	{
		...
		tg->register_dserver_constructor(&DCS210PC_ns::constructor);
#endif
...
/* clang-format off */
/*----- PROTECTED REGION END -----*/	//	DCS210PC::main.cpp
